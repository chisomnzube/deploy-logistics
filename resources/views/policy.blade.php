...
<head>
  ...
  <title>Policy - {{config('app.name')}} </title>
  <link rel="stylesheet"
...
@section('main-content')
    ...
    <section id="page-title" class="page-title bg-overlay bg-parallax">
      <div class="bg-img"><img src="{{ asset('images/about_us.jpg') }}" alt="Policy {{config('app.name')}} "></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <h1 class="pagetitle__heading">Policy</h1>
          </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.page-title -->
